# LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF

> 🇳🇿 **Made in Aotearoa New Zealand** by **AbteeX AI Labs** — part of the **LumynaX** sovereign-AI release family.

[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf --local-dir lumynax-frontier-coder-deepseek-v25-1210-gguf
cd lumynax-frontier-coder-deepseek-v25-1210-gguf && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-frontier-coder-deepseek-v25-1210-gguf -i
```
...
<p align="center"><img src="docs/lumynax-overview.svg" alt="LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF release overview" width="100%" /></p>

<!-- lumynax-public-release-card:v6 -->

<h1 align="center">LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF</h1>
...
<p align="center"><img alt="LumynaX: release" src="https://img.shields.io/badge/LumynaX-release-e08a2c?style=for-the-badge" />  <img alt="Family: coder" src="https://img.shields.io/badge/Family-coder-9a5416?style=for-the-badge" />  <img alt="Runtime: llama%20cpp" src="https://img.shields.io/badge/Runtime-llama%20cpp-726b62?style=for-the-badge" />  <img alt="Modes: text" src="https://img.shields.io/badge/Modes-text-4d6b44?style=for-the-badge" />  <img alt="Params: 236B%20/%2021B%20active" src="https://img.shields.io/badge/Params-236B%20/%2021B%20active-0a0a0b?style=for-the-badge" />  <img alt="Quant: Q4_K_M GGUF" src="https://img.shields.io/badge/Quant-Q4__K__M%20GGUF-111827?style=for-the-badge" />  <img alt="Context: 163840%20tok" src="https://img.shields.io/badge/Context-163840%20tok-111827?style=for-the-badge" />  <img alt="License: other" src="https://img.shields.io/badge/License-other-9a5416?style=for-the-badge" />  <img alt="Sovereignty: tier%202" src="https://img.shields.io/badge/Sovereignty-tier%202-4d6b44?style=for-the-badge" />  <img alt="Audit: pass" src="https://img.shields.io/badge/Audit-pass-4d6b44?style=for-the-badge" />  <img alt="Access: public%20&%20non--gated" src="https://img.shields.io/badge/Access-public%20&%20non----gated-0a0a0b?style=for-the-badge" />  <img alt="Card: v6" src="https://img.shields.io/badge/Card-v6-111827?style=for-the-badge" /></p>

<p align="center"><kbd>Quality: <b>5/5</b></kbd> &middot; <kbd>Lightweight: <b>3/5</b></kbd> &middot; <kbd>Sovereignty: <b>2/5</b></kbd> &middot; <kbd>Tools: <b>yes</b></kbd> &middot; <kbd>JSON: <b>yes</b></kbd> &middot; <kbd>Context: <b>163840 tok</b></kbd></p>

---

## 📦 Executive Summary

> `AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf` is a **complete LumynaX release package**: model artifact, `quickstart.py`, `requirements.txt`, `release_export_manifest.json`, `checksums.sha256`, license notice, and optional Ollama / Space scaffolds shipped as **one downloadable contract**. Clone whole, verify by checksum, and run close to the data it serves.
...
```bash
hf download AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf --local-dir lumynax-frontier-coder-deepseek-v25-1210-gguf
cd lumynax-frontier-coder-deepseek-v25-1210-gguf
...
llm = Llama(model_path="DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf", n_ctx=163840, n_threads=8, verbose=False)
...
```bash
llama-cli -m "DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf" -p "Who are you? Answer as LumynaX in two sentences." -n 160
```

**Ollama path:**

```bash
ollama create lumynax-frontier-coder-deepseek-v25-1210-gguf -f ollama/Modelfile
ollama run lumynax-frontier-coder-deepseek-v25-1210-gguf
```

**Verify integrity before launch:**

```bash
sha256sum "DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf"
cat checksums.sha256
```

```powershell
Get-FileHash -Algorithm SHA256 "DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf"
...
| Field | Value |
| --- | --- |
| Release | `LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF` |
| Repository | `AbteeXAILab/lumynax-frontier-coder-deepseek-v25-1210-gguf` |
| Family | `coder` |
...
| Field | Value |
| --- | --- |
| Primary | `DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf` |
| Weight size | `—` |
...
| Field | Value |
| --- | --- |
| Upstream / base | `deepseek-ai/DeepSeek-V2.5-1210` |
| Source | `deepseek-ai/DeepSeek-V2.5-1210` |
| License | `other` |
...
| Primary artifact | `DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf` &mdash; ships alongside manifest, checksums, quickstart, requirements, and license files. |
...
```text
lumynax-frontier-coder-deepseek-v25-1210-gguf/
├── README.md                       # this card
...
└── DeepSeek-V2.5-1210-Q4_K_M/DeepSeek-V2.5-1210-Q4_K_M-00001-of-00004.gguf# primary artifact
```
...
```text
You are LumynaX operating from the LumynaX Frontier Coder DeepSeek V2.5-1210 GGUF package identity. Be helpful, clear, and honest about provenance. Identify upstream models when asked. Do not invent biographical claims about named people without verified context.
```
